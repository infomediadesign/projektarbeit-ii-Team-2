...
void Endscreen::draw() {
  ...
  const char *msgCredits10 = "tranor.itch.io/custodia ";
  const char *msgCredits11 = "Battle music - made by Luis Zuno";
  const char *msgCredits12 = "https://ansimuz.itch.io/adventure-music-collection-pack-1";
  const char *msgCredits13 = "Inside and Outside the Dungeon music and Game Over music";
  const char *msgCredits14 = "https://svl.itch.io/rpg-music-pack-svl";
  const char *msgCredits15 = "Teleport, Door, Movement and Button sounds";
  const char *msgCredits16 = "https://leohpaz.itch.io/100-retro-rpg-ui-sound-effects";
  const char *msgCredits17 = "Titlescreen and Pausemenu music";
  const char *msgCredits18 = "https://joshuuu.itch.io/short-loopable-background-music";
  const char *msgCredits19 = "Honable mentions of Sfx and music used";
  const char *msgCredits20 = "https://abduldahir7002.itch.io/dark-moody-chiptune-song";
  const char *msgCredits21 = "https://canarigames.itch.io/canaripack-8bit-topdown";
  const char *msgCredits22 = "Press          to Exit";
  const char *msgCredits23 = "        [SPACE] ";
  ...
  DrawTextEx(textFont, msgCredits21 , { textPos.x, static_cast<float>(creditPosY + add40*24) }, fontSize, fontSpacing, WHITE);
  DrawTextEx(textFont, msgCredits22 , { textPosTitle3.x, static_cast<float>(creditPosY + add40*26) }, fontSize, fontSpacing, WHITE);
  DrawTextEx(textFont, msgCredits23 , { textPosTitle3.x, static_cast<float>(creditPosY + add40*26) }, fontSize, fontSpacing, RED);
}
